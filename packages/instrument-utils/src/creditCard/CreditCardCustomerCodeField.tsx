...
const CreditCardCustomerCodeField: FunctionComponent<CreditCardCustomerCodeFieldProps> = ({
    ...
    const optionalIndicator = useMemo(
        () => {
            ...
            const labelText = 'Credit Card Customer Code'; // This field is not a phone field, so return null
            const isPhoneField = labelText.toLowerCase().includes('phone');
            ...
            return (
                <>
                    <span className="optional-indicator" aria-hidden="true">
                        <svg aria-labelledby="IconCardCustomerCode" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
