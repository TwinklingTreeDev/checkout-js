...
describe('PaymentPreloader', () => {
    ...
    it('never preloads PayPal methods even if they are in the methods list', async () => {
        jest.useFakeTimers();
        ...
        const component = mount(<PaymentPreloader {...defaultProps} methods={paypalMethods} />);
        ...
        // Should not preload any PayPal methods
        expect(defaultProps.checkoutService.initializePayment).not.toHaveBeenCalled();
